...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    name: 'Trains',
    emoji: '🚆',
    bg: 'from-amber-300 via-orange-200 to-red-300',
    accent: 'text-amber-800',
    buttonBg: 'bg-amber-600',
    animatedBg: 'linear-gradient(135deg, #fcd34d, #fed7aa, #fb923c, #fca5a5, #fde68a)',
    items: [
      {
        id: 'steamtrain',
        emoji: '🚂',
      ...
      },
      {
        ...
        label: 'Bullet Train',
        color: '#a3c9e6',
        sound: { freq: 330, type: 'sawtooth', duration: 0.5 },
        animation: 'shake',
      },
      {
        id: 'hispeed',
        ...
        label: 'Fast Train',
        color: '#b3d9ff',
        sound: { freq: 392, type: 'sawtooth', duration: 0.5 },
        animation: 'wiggle',
      },
      {
        id: 'metro',
      ...
      },
      {
        ...
        label: 'Tram',
        color: '#a3e6a3',
        sound: { freq: 262, type: 'triangle', duration: 0.4 },
        animation: 'wiggle',
      },
      {
        id: 'monorail',
      ...
      },
      {
        ...
        label: 'Wagon',
        color: '#f4a3a3',
        sound: { freq: 165, type: 'square', duration: 0.5 },
        animation: 'shake',
      },
      {
        id: 'station',
    ...
    slides: [
      {
        ...
        animatedBg: 'linear-gradient(135deg, #fbbf24, #ea580c, #fb923c, #f59e0b, #fed7aa)',
        title: 'All Aboard!',
        scene: '🚂🚃🚉',
        description: 'The train chugs down the track!',
      },
      {
        ...
        animatedBg: 'linear-gradient(135deg, #7dd3fc, #3b82f6, #38bdf8, #2563eb, #bfdbfe)',
        title: 'Super Fast',
        scene: '🚄🚅💨',
        description: 'The bullet train zooms by!',
      },
      {
        id: 'train3',
        bg: 'from-green-300 to-emerald-500',
        animatedBg: 'linear-gradient(135deg, #86efac, #10b981, #6ee7b7, #059669, #a7f3d0)',
        title: 'City Ride',
        scene: '🚊🚇🏙️',
        description: 'The tram rolls through town!',
      },
      {
        id: 'train4',
        bg: 'from-purple-300 to-indigo-500',
        animatedBg: 'linear-gradient(135deg, #d8b4fe, #6366f1, #c084fc, #4f46e5, #e879f9)',
        title: 'At the Station',
        scene: '🚉🚝🎫',
        description: 'Trains wait at the station!',
      },
    ],
  },
]
